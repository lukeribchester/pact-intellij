...
public class PactArithmeticOperatorImpl extends ASTWrapperPsiElement implements PactArithmeticOperator {

  public PactArithmeticOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
