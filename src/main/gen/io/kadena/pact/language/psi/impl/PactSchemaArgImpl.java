...
public class PactSchemaArgImpl extends ASTWrapperPsiElement implements PactSchemaArg {

  public PactSchemaArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitSchemaArg(this);
  }
