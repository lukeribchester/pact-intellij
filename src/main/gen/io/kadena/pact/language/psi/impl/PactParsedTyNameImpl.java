...
public class PactParsedTyNameImpl extends ASTWrapperPsiElement implements PactParsedTyName {

  public PactParsedTyNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitParsedTyName(this);
  }
