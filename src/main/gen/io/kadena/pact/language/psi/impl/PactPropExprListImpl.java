...
public class PactPropExprListImpl extends ASTWrapperPsiElement implements PactPropExprList {

  public PactPropExprListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitPropExprList(this);
  }
