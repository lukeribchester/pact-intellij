...
public class PactMDocOrModelImpl extends ASTWrapperPsiElement implements PactMDocOrModel {

  public PactMDocOrModelImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitMDocOrModel(this);
  }
