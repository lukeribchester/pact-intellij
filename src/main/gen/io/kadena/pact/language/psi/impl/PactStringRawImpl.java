...
public class PactStringRawImpl extends ASTWrapperPsiElement implements PactStringRaw {

  public PactStringRawImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitStringRaw(this);
  }
