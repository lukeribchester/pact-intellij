...
public class PactProgNExprImpl extends ASTWrapperPsiElement implements PactProgNExpr {

  public PactProgNExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitProgNExpr(this);
  }
