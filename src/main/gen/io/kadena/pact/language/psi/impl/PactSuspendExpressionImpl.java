...
public class PactSuspendExpressionImpl extends ASTWrapperPsiElement implements PactSuspendExpression {

  public PactSuspendExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitSuspendExpression(this);
  }
