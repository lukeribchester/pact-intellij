...
public class PactPropExpressionImpl extends ASTWrapperPsiElement implements PactPropExpression {

  public PactPropExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitPropExpression(this);
  }
  ...
  public PactPropExpressionList getPropExpressionList() {
    return findChildByClass(PactPropExpressionList.class);
  }
