...
public class PactExprCommaSepImpl extends ASTWrapperPsiElement implements PactExprCommaSep {

  public PactExprCommaSepImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitExprCommaSep(this);
  }
