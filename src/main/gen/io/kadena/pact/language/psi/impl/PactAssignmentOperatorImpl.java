...
public class PactAssignmentOperatorImpl extends ASTWrapperPsiElement implements PactAssignmentOperator {

  public PactAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
