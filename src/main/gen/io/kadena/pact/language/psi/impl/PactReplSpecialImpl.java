...
public class PactReplSpecialImpl extends ASTWrapperPsiElement implements PactReplSpecial {

  public PactReplSpecialImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitReplSpecial(this);
  }
