...
public class PactGenericExpressionImpl extends ASTWrapperPsiElement implements PactGenericExpression {

  public PactGenericExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
