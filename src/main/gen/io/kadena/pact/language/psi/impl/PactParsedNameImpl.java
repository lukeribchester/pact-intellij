...
public class PactParsedNameImpl extends ASTWrapperPsiElement implements PactParsedName {

  public PactParsedNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitParsedName(this);
  }
