...
public class PactMCommaExprImpl extends ASTWrapperPsiElement implements PactMCommaExpr {

  public PactMCommaExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitMCommaExpr(this);
  }
