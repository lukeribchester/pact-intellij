...
public class PactGenAppExprImpl extends ASTWrapperPsiElement implements PactGenAppExpr {

  public PactGenAppExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitGenAppExpr(this);
  }
  ...
  public PactAppBindList getAppBindList() {
    return findNotNullChildByClass(PactAppBindList.class);
  }
