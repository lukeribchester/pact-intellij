...
public class PactSuspendExprImpl extends ASTWrapperPsiElement implements PactSuspendExpr {

  public PactSuspendExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitSuspendExpr(this);
  }
