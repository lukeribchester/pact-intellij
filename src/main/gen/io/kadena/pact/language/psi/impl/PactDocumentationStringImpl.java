...
public class PactDocumentationStringImpl extends ASTWrapperPsiElement implements PactDocumentationString {

  public PactDocumentationStringImpl(@NotNull ASTNode node) {
    super(node);
  }
