...
public interface PactTypes {
  ...
  IElementType KEYWORD_DEF_PROPERTY = new PactTokenType("defproperty");
  ...
  IElementType KEYWORD_ERROR = new PactTokenType("error");
  ...
  IElementType KEYWORD_INVARIANT = new PactTokenType("invariant");
  ...
  IElementType KEYWORD_PROPERTY = new PactTokenType("property");
