...
public interface PactTypes {
  ...
  IElementType BINDASSIGN = new PactTokenType(":=");
  IElementType BLESS = new PactTokenType("bless");
  IElementType BLOCKINTRO = new PactTokenType("progn");
  IElementType CLOSEBRACE = new PactTokenType("}");
  IElementType CLOSEBRACKET = new PactTokenType("]");
  IElementType CLOSEPARENS = new PactTokenType(")");
  IElementType COLON = new PactTokenType(":");
  IElementType COMMA = new PactTokenType(",");
  IElementType COMMENT = new PactTokenType("Comment");
  IElementType CREATEUSERGUARD = new PactTokenType("c_usr_grd");
  IElementType DEFCAP = new PactTokenType("defcap");
  IElementType DEFCONST = new PactTokenType("defconst");
  IElementType DEFPACT = new PactTokenType("defpact");
  IElementType DEFSCHEMA = new PactTokenType("defschema");
  IElementType DEFTABLE = new PactTokenType("deftable");
  IElementType DEFUN = new PactTokenType("defun");
  IElementType DOCANN = new PactTokenType("docAnn");
  IElementType DOT = new PactTokenType(".");
  IElementType DYNACC = new PactTokenType("::");
  IElementType ENFORCE = new PactTokenType("enforce");
  IElementType ENFORCEONE = new PactTokenType("enforceOne");
  IElementType EVENTANN = new PactTokenType("eventAnn");
  ...
  IElementType IMPORT = new PactTokenType("import");
  IElementType INTERFACE = new PactTokenType("interface");
  IElementType LAMBDA = new PactTokenType("lam");
  IElementType LET = new PactTokenType("let");
  IElementType LOAD = new PactTokenType("load");
  IElementType MANAGEDANN = new PactTokenType("managedAnn");
  IElementType MODELANN = new PactTokenType("modelAnn");
  IElementType MODULE = new PactTokenType("module");
  IElementType NUMBER = new PactTokenType("Number");
  IElementType OPENBRACE = new PactTokenType("{");
  IElementType OPENBRACKET = new PactTokenType("[");
  IElementType OPENPARENS = new PactTokenType("(");
  IElementType OR = new PactTokenType("or");
  IElementType SINGLETICK = new PactTokenType("'");
  IElementType STEP = new PactTokenType("step");
  IElementType STEPWITHROLLBACK = new PactTokenType("steprb");
  ...
  IElementType WITHCAPABILITY = new PactTokenType("withcap");
  ...
  IElementType _BLOCK_ = new PactTokenType("<Block>");
  ...
  IElementType _IMPORTLIST_ = new PactTokenType("<ImportList>");
  ...
  IElementType _PARSEDNAME_ = new PactTokenType("<ParsedName>");
