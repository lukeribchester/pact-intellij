...
public class PactParsedTypeNameImpl extends ASTWrapperPsiElement implements PactParsedTypeName {

  public PactParsedTypeNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitParsedTypeName(this);
  }
