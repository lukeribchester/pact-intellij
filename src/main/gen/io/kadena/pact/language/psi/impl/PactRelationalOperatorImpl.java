...
public class PactRelationalOperatorImpl extends ASTWrapperPsiElement implements PactRelationalOperator {

  public PactRelationalOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
