...
public class PactSingleBindImpl extends ASTWrapperPsiElement implements PactSingleBind {

  public PactSingleBindImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitSingleBind(this);
  }
