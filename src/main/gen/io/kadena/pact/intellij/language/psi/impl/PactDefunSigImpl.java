...
public class PactDefunSigImpl extends ASTWrapperPsiElement implements PactDefunSig {

  public PactDefunSigImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitDefunSig(this);
  }
