...
public class PactUcLetterImpl extends ASTWrapperPsiElement implements PactUcLetter {

  public PactUcLetterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitUcLetter(this);
  }
