...
public class PactModuleGuardImpl extends ASTWrapperPsiElement implements PactModuleGuard {

  public PactModuleGuardImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitModuleGuard(this);
  }
