...
public class PactTopLevelListImpl extends ASTWrapperPsiElement implements PactTopLevelList {

  public PactTopLevelListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitTopLevelList(this);
  }
  ...
  @Override
  @Nullable
  public PactTopLevelList getTopLevelList() {
    return findChildByClass(PactTopLevelList.class);
  }
