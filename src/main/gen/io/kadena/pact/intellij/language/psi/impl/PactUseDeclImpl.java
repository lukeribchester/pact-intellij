...
public class PactUseDeclImpl extends ASTWrapperPsiElement implements PactUseDecl {

  public PactUseDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PactUse getUse() {
    return findNotNullChildByClass(PactUse.class);
  }
