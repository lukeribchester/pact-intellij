...
public class PactLetStarBindImpl extends ASTWrapperPsiElement implements PactLetStarBind {

  public PactLetStarBindImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitLetStarBind(this);
  }
  ...
  @Override
  @Nullable
  public PactSingleBind getSingleBind() {
    return findChildByClass(PactSingleBind.class);
  }
