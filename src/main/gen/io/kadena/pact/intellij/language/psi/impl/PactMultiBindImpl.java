...
public class PactMultiBindImpl extends ASTWrapperPsiElement implements PactMultiBind {

  public PactMultiBindImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitMultiBind(this);
  }
