...
public class PactStringLitImpl extends ASTWrapperPsiElement implements PactStringLit {

  public PactStringLitImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PactString getString() {
    return findNotNullChildByClass(PactString.class);
  }
