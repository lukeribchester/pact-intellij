...
public class PactNeExprListImpl extends ASTWrapperPsiElement implements PactNeExprList {

  public PactNeExprListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitNeExprList(this);
  }
