...
public class PactSigListImpl extends ASTWrapperPsiElement implements PactSigList {

  public PactSigListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitSigList(this);
  }
  ...
  @Override
  @Nullable
  public PactDefunSig getDefunSig() {
    return findChildByClass(PactDefunSig.class);
  }
