...
public class PactObjectLitImpl extends ASTWrapperPsiElement implements PactObjectLit {

  public PactObjectLitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PactVisitor visitor) {
    visitor.visitObjectLit(this);
  }
